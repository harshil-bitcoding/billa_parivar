...
urlpatterns = [
    ...
    path("api/v4/relation", V4Views.V4ParentChildRelationDetailView.as_view(), name="relation_v3_v4"),
    path("api/v4/relation/<str:surnameid>", V4Views.V4ParentChildRelationDetailView.as_view(), name="relation_v3_detail_v4"),
    path("api/v4/get-person-by-surname", V4Views.V4PersonBySurnameView.as_view(), name="get_person_by_surname_v3_v4"),
    ...
    path("api/v4/surname", V4Views.V4SurnameDetailView.as_view(), name="surname_v3_v4"),
    path("api/v4/banner", V4Views.V4BannerDetailView.as_view(), name="banner_v3_v4"),
    path("api/v4/banner/<int:pk>", V4Views.V4BannerDetailView.as_view(), name="banner_v3_detail_v4"),
